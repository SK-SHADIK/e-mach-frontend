...
const UpdateProfileFish=()=>{
    ...
    useEffect(()=>{
        axios.get(`https://localhost:44355/api/fishermans/${localStorage.getItem("User_Name")}`).then((res)=>{
            setInputs({
                Id:res.data.Id,
                Name:res.data.Name,
    ...
    const submitForm = (e) =>{
        ...
        axios.post("https://localhost:44355/api/fisherman/update", fData)
        .then((rsp)=>{
...
export default UpdateProfileFish;