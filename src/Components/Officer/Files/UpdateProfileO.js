...
const UpdateProfileO=()=>{
    ...
    useEffect(()=>{
        axios.get(`https://localhost:44355/api/officers/${localStorage.getItem("User_Name")}`).then((res)=>{
            setInputs({
                Id:res.data.Id,
                Name:res.data.Name,
    ...
    const submitForm = (e) =>{
        ...
        axios.post("https://localhost:44355/api/officer/update", fData)
        .then((rsp)=>{
