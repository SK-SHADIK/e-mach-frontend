...
const UpdateOfficer=(props)=>{
    ...
    useEffect(()=>{
        axios.get(`https://localhost:44355/api/officer/${Id}`).then((res)=>{
            setInputs({
                Id:res.data.Id,
                Name:res.data.Name,
    ...
    const submitForm = (e) =>{
        ...
        console.log(inputs);
        axios.post(`https://localhost:44355/api/officer/update`, inputs).then((rsp)=>{
                ...
                <div class="containerf">
                    <div class="contentf">
                        <div class="contentf-3">
                            <h1>Update A Officer Details</h1>
